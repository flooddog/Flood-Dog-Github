...
#include "Particle.h"
#line 1 "/Users/philipchatterton/IoCP/Particle/Flood_Dog/Flood_Dog_v06/src/Flood_Dog_v06.ino"
////////////////////////////////
//                            //
//         Flood Dog          //
//       Water Sensor         //
...
#line 8 "/Users/philipchatterton/IoCP/Particle/Flood_Dog/Flood_Dog_v06/src/Flood_Dog_v06.ino"
PRODUCT_ID(15526);
PRODUCT_VERSION(11);
...
const int MAX_TIME_TO_WAIT_BEFORE_SLEEP_MS = (1 * 1000);			// After publish, wait [1] seconds for data to go out
const int MAX_TIME_TO_SLEEP_SEC = (15 * 60); 						// sleep for [15] minutes in seconds -- [0] second for debug
...
void loop() {
	...
	switch(state){
		...
		case PUBLISH_STATE:
			...
			// ubidots.add("Flood_Dog-Power-Source", (char*)powerSString);
