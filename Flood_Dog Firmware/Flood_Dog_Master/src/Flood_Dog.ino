/*
* Project: 42 Flood Dogs for GLOS 2021 
* Description: Cellular Connected Data Logger for ground, surface and lake water levels around the Toronto Islands 
* Author: Philip Chatterton
* Date: 22 December, 2021

BASED ON A PROECT BY Chip McClelland
...
//FDv40 - Branch from v44.00 Visitation-Counters-master continued from v38 Flood_Dog_07.ino
...
struct currentCounts_structure {                    // currently 10 bytes long
  ...
  int placeHolderInteger;                           // This spot is available for future use
