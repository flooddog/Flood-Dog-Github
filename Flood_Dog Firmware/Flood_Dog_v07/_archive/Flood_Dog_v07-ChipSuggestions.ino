...
SerialLogHandler logHandler(LOG_LEVEL_ALL);			// Sends everything
///////////////////////////////////////////////////////////////////////////
...
//#include "OneWire.h"														// Should not need this - I beleive you are using i2c not one-wire
#include "Adafruit_Sensor.h"
#include "Adafruit_ADXL343.h"
#include "Adafruit_ADT7410.h"

//#include "Ubidots.h"													// Let's try it without the library

//  #include "JsonParserGeneratorRK.h"					// Don't think you need this either
///////////////////////////////////////////////////////////////////////////
...
//String powerSString;				// No Strings - ever!
...
//
void setup() {
	// Serial.begin(115200);		// Serial and Serial log handling - don't need both
...
////   This is the context  section  - not needed in this appoach
...
//////////
			...
			*/
			...
			snprintf(data, sizeof(data), "{\"Capacitance\":%i, \"InternalTemp\":%i, \"battery\":%i, \"key1\":\"%s\", \"timestamp\":%lu000}",analogValue, temperatureC,fuel.getVCell(),batteryStates[context],Time.now());
			Particle.publish("Ubidots-Hook-v1", data, PRIVATE);			// Note, you can add Publish Queue POSIX later - let's get this going first
